      ...
      <div className="flex flex-wrap items-center justify-center text-left mt-4 gap-y-4">
        <div className="relative flex items-center justify-center">
          <input
            type="text"
            id="floating_filled"
            className="block min-h-[48px] md:min-h-[56px] max-w-[284px] md:max-w-[404px] md:min-w-[403px] text-white leading-6 bg-[rgba(0,0,0,0.29)] border pl-6 pt-4 pb-2 border-gray-400 rounded peer"
            placeholder=" "
          />
          <label
            for="floating_filled"
