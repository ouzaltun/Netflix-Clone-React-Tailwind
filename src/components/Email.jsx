    ...
    <div>
      <div className="flex flex-wrap items-center justify-center text-left mt-4 gap-y-4">
        <div className="relative flex items-center justify-center">
          ...
          <label
            for="floating_filled"
            className="absolute text-[14px] text-[#B7B7B7] pl-2   tracking-wide dark:text-[#B7B7B7] duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4"
          >
            E-posta adresi
          </label>
        </div>
          ...
          <button className=" border 0.5rem 1rem px-4 md:px-6 border-black bg-netflix text-white text-lg md:text-2xl cursor-pointer  tracking-[-0.4px] rounded font-bold transition-colors hover:bg-[#c11119]">
            <div className=" flex justify-center items-center h-[48px] md:h-[56px] pb-1">
              ...
              <div className=" h-[32px] w-[24px]">
                <IoIosArrowForward className="inline-block ml-2 h-full w-full mb-1"></IoIosArrowForward>
              </div>
            </div>
          </button>
        </div>
