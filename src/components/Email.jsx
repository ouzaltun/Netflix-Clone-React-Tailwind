    ...
    <div>
      <div className="flex flex-wrap items-center justify-center text-left mt-4 gap-y-4">
        ...
        <div className="ml-2   ">
          <button
            onClick={FocusInput}
            className=" border 0.5rem 1rem px-4 md:px-6 border-black bg-netflix text-white text-lg md:text-2xl cursor-pointer  tracking-[-0.4px] rounded font-bold transition-colors hover:bg-[#c11119]"
          >
