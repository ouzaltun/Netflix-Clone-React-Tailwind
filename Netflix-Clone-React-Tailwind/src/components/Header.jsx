...
function Header() {
  ...
  return (
    <div className="w-full h-[92px]">
      <div className="flex container justify-between h-[92px] mx-auto w-[1186px] items-center">
        <div className="">
          <svg
            fill="#e50914"
            height={40}
        ...
        <div className="flex justify-center items-center">
              ...
              <Listbox value={selected} onChange={setSelected}>
                <div className="relative bg-[#161616b3] border border-[#808080b3] rounded">
                  <Listbox.Button className="relative flex justify-end items-center w-full  text-left width-[126.4px] h-8 gap-2 px-3 text-base font-normal">
                    ...
                    <span className="pointer-events-none pt-[2px]  ">
                      <svg
                        fill="#000"
                        width="16"
                        height="16"
          ...
          <div>
            <div
              className="bg-netflix text-white text-[14px] ml-6 mr-3 cursor-pointer flex py-1 px-4 min-h-[32px] tracking-tight
             rounded font-medium transition-colors hover:bg-[#c11119]"
            >
              Oturum Aç
            </div>
          </div>
